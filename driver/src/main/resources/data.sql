...
values (7,
        ...
        now(), now(), false, 'OFFLINE', 'driver07pw', 'driver07');
...
values (8,
        'aced0005737200226f72672e737072696e676672616d65776f726b2e646174612e67656f2e506f696e7431b9e90ef11a4006020002440001784400017978704023000000000000404bfa1cac083127',
        now(), now(), false, 'ONLINE', 'driver08pw', 'driver08');

-- Task 1: Create 1 ONLINE driver with selected Car
-- Please go to 002_insert_data.sql

-- Car Engine
INSERT INTO car_engine (id, name, deleted, date_created)
VALUES (1, 'ELETRIC', false, now()),
       (2, 'GAS', false, now()),
       (3, 'DIESE', false, now()),
       (4, 'GAS ELETRIC', false, now())
;

-- Car Manufacturer
INSERT INTO car_manufacturer (id, name, deleted, date_created)
VALUES (1, 'FIAT', false, now()),
       (2, 'VOLKSWAGEN', false, now()),
       (3, 'OPEL', false, now()),
       (4, 'FORD', false, now()),
       (5, 'NISSAN', false, now())
;