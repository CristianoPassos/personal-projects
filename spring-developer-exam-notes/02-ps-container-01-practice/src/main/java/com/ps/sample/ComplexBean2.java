 ...
 * This class contains all the methods used to initialize and destroy a bean altogether, so you can the order they are
 * called in.
 */
public class ComplexBean2 {
    ...
    // DONE 10. Add JSR 250 attributes to control initialization and destruction of this bean
