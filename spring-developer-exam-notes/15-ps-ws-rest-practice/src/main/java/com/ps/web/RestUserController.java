...
//DONE 55. Place proper annotation here, to make this class handle REST requests
@RestController
public class RestUserController {
    ...
    //DONE 56. Place proper annotations to handle a REST POST request
    ...
    @ResponseStatus(HttpStatus.OK)
    //DONE 57. Choose the proper HTTP method type to resolve a HTTP REST PUT request
