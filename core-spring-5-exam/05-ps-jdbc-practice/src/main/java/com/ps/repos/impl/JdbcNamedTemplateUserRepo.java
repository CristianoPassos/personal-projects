...
public class JdbcNamedTemplateUserRepo implements UserRepo {
    ...
    public int createUser(Long userId, String username, String password, String email) {
        final String query = "insert into p_user(ID, USERNAME, PASSWORD, EMAIL) values(:id,:un,:pass, :email)";
    ...
    public User findById(Long id) {
        ...
        final String sql = "select id, email, username,password from p_user where id= :id";
        final Map params = new HashMap<String, Object>() {{
            put("id", id);
        }};
