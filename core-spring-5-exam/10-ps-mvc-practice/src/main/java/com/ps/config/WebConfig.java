...
// DONE 45. Add the proper annotation to enable Spring @MVC
@EnableWebMvc
@Configuration
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public InternalResourceViewResolver getViewResolver() {
        // DONE 46. Complete the definition for a bean of type InternalResourceViewResolver that will map the requests to views
