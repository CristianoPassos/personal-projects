...
@NamedQueries({
        @NamedQuery(name = User.FIND_BY_USERNAME_EXACT, query = "SELECT u FROM User u WHERE username = :un"),
        @NamedQuery(name = User.FIND_BY_USERNAME_LIKE, query = "SELECT u FROM User u WHERE username LIKE :un")
})
